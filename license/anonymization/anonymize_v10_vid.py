import cv2
import os
from ultralytics import YOLO  # Supports YOLOv10 models

def blur_with_yolov10(model_path, input_path, output_path,
                      blur_kernel=(51, 51), device="cpu", conf_threshold=0.25):
    """
    Generalized YOLOv10 blurring script.
    - Works with images, videos, or folders of images
    - Blurs detected objects based on YOLOv10 bounding boxes
    """
...
# -------- Example usage --------
MODEL_PATH = r"C:\Users\bibik\OneDrive\Desktop\test\yolov10n.pt"
...
# Example 2: For folder of images
# blur_with_yolov10(MODEL_PATH, "path/to/images_folder", "path/to/output_folder", device=0)

# Example 3: For single image
# blur_with_yolov10(MODEL_PATH, "input.jpg", "output.jpg", device=0)